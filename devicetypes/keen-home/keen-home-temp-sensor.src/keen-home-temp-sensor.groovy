/**
 *  Keen Home Temp Sensor
 * http://www.keenhome.io
 * Updated based on original Keen Home Smart Vent Device Handler  
 *
 */
 
 
metadata {
	definition (name: "Keen Home Temp Sensor", namespace: "Keen Home", author: "Keen Home") {

		// Should Relative Humidity Measurement be added?
...
//        fingerprint endpoint: "1", profileId: "0104", deviceId: "0302", inClusters: "0000,0001,0003,0004,0005,0020,0402,0B05,FC01,FC02", outClusters: "0019", deviceJoinName: "Keen Home Temp Sensor"
	...
	tiles {
        ...
        // TODO: Add pressure information tile
